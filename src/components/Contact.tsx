...
export default function Contact({ initialProjectType = '' }: ContactProps) {
  ...
  return (
    <section id="contact" className="scroll-mt-24 bg-[#FAF5F5] py-24 border-b border-red-100 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          {/* Left Side Content */}
          <div className="lg:col-span-5 flex flex-col items-start text-left">
            <span className="text-[13px] font-extrabold tracking-[0.2em] text-[#E10F0F] uppercase px-3 py-1 bg-red-50 border border-red-100 rounded-full mb-6">
              Connect
            </span>
            ...
            <p className="text-[16px] text-slate-500 max-w-sm leading-relaxed py-10">
            ...
            <div className="space-y-6 w-full max-w-md">
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-display font-semibold text-[16px] text-slate-900 group-hover:text-[#E10F0F] transition-colors">
              ...
              <div className="flex items-center gap-4 p-4 border border-red-100/50 bg-white rounded-xl shadow-sm">
                ...
                <div>
                  ...
                  <p className="font-display font-semibold text-[16px] text-slate-900">
          ...
          <div className="lg:col-span-7 bg-white border border-red-100 p-6 sm:p-8 md:p-12 rounded-3xl shadow-xl relative">
              ...
              {!isSuccess ? (
                ...
                >
                  ...
                  <div className="flex flex-col gap-2">
                    <label htmlFor="name" className="text-[16px] text-slate-500 font-bold uppercase tracking-wider">
                      Your Name *
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full bg-slate-50 border border-slate-200 hover:border-slate-300 focus:border-[#E10F0F]/80 rounded-xl px-5 py-4 text-slate-950 text-[16px] focus:outline-none focus:bg-white transition-all"
                    />
                  </div>

                  {/* Email field */}
                  <div className="flex flex-col gap-2">
                    <label htmlFor="email" className="text-[16px] text-slate-500 font-bold uppercase tracking-wider">
                      Email Address *
                    </label>
                    <input
                      type="email"
                  ...
                  {/* Project Type - single column on mobile */}
                  <div className="flex flex-col gap-2.5">
                    <label className="text-[16px] text-slate-500 font-bold uppercase tracking-wider mb-1">
                      Project Type
                    </label>
                        ...
                        return (
                          <button
                            ...
                            onClick={() => setFormData({ ...formData, projectType: type })}
                             className={`py-3 rounded-xl border font-bold text-[16px] tracking-wide transition-all duration-200 cursor-pointer ${
                              isSelected
                   ...
                   {/* Budget Selector - single column on mobile */}
                   <div className="flex flex-col gap-2.5">
                     <label className="text-[13px] text-slate-700 font-bold uppercase tracking-wider mb-1">
                         ...
                         return (
                           <button
                             ...
                             onClick={() => setFormData({ ...formData, budget: budget })}
                              className={`px-4 py-2.5 rounded-xl border font-bold text-[16px] tracking-wide transition-all duration-200 cursor-pointer ${
                               isSelected
                  ...
                  <div className="flex flex-col gap-2">
                    <label htmlFor="message" className="text-[13px] text-slate-700 font-bold uppercase tracking-wider">
                    ...
                    <textarea
                      ...
                      className="w-full bg-slate-50 border text-justify border-slate-200 hover:border-slate-300 focus:border-[#E10F0F]/80 rounded-xl px-5 py-4 text-slate-950 text-[16px] focus:outline-none focus:bg-white transition-all resize-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="magnetic-btn w-full py-4.5 bg-[#E10F0F] hover:bg-[#C90D0D] text-white font-display font-black text-[16px] uppercase tracking-widest rounded-xl flex items-center justify-center gap-2.5 transition-all duration-300 cursor-pointer shadow-xl shadow-[#E10F0F]/10 hover:shadow-2xl hover:shadow-[#E10F0F]/25 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50"
                  >
                    {isSubmitting ? (
                      <>
                ...
                >
                  ...
                  <h3 className="font-display font-extrabold text-[18px] md:text-[20px] text-slate-950 mb-2 tracking-tight">
                    Inquiry Safely Received!
                  </h3>
                  <p className="text-[16px] text-slate-700 max-w-sm leading-relaxed mb-6">
                  ...
                  <div className="p-4 bg-red-50/30 border border-red-100 rounded-xl border-l-2 border-[#E10F0F] flex items-start gap-3 max-w-xs text-left">
                    ...
                    <span className="text-[13px] text-justify text-slate-700">

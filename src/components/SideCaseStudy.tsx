...
export const SideCaseStudy: React.FC = React.memo(() => {
  return (
    <section id="case-studies" className="scroll-mt-24 bg-slate-900 text-white rounded-2xl overflow-hidden border border-slate-800 shadow-xl group">
      <div className="grid grid-cols-1 sm:grid-cols-12 items-center">
        ...
        {/* Right Side: Content */}
        <div className="sm:col-span-7 p-7 text-center md:text-left space-y-4">
          <span className="text-[13px] font-extrabold tracking-[0.2em] text-[#E10F0F] uppercase block">
            Case Study
          </span>
          <h3 className="text-[18px] md:text-[20px] font-black tracking-tight leading-snug font-display">
            See How I Transform <br />
            Ideas Into Powerful Brands
          </h3>
          <p className="text-[16px] leading-relaxed text-slate-400 font-medium">
            Check out our detailed case studies and see the process behind the final design.
          </p>
          <div className="pt-1">
            <a
              href="#case-studies"
              className="inline-flex items-center gap-2 bg-white hover:bg-slate-50 text-slate-900 text-[13px] font-extrabold py-2.5 px-5 rounded-xl transition-colors duration-200"
            >
              View Case Studies

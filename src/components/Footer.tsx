...
export const Footer: React.FC = () => {
  ...
  const services = [
    ...
    { name: "Merchandise Design", href: "#services" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-6 text-left">
            <div className="[&_.text-slate-900]:!text-white [&_.text-slate-500]:!text-slate-400">
              <ZukhrufLogo />
            </div>
          ...
          <div className="text-left space-y-5">
            <h4 className="text-[11px] font-extrabold tracking-[0.2em] text-white uppercase font-display">
              Quick Links
            </h4>
          ...
          <div className="text-left space-y-5">
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                ...
                <span className="text-[12px] font-medium text-slate-400">+880 1234-567890</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center shrink-0">
                  <Mail className="w-4 h-4 text-[#E10F0F]" />
                </div>
                <span className="text-[12px] font-medium text-slate-400">hello@zukhruf.com</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-8 h-8 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center shrink-0">
                  <MapPin className="w-4 h-4 text-[#E10F0F]" />
                </div>
                <span className="text-[12px] font-medium text-slate-400">Dhaka, Bangladesh</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-900 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-[11px] font-medium text-slate-500 text-center sm:text-left">
            © 2025 Zukhruf. All rights reserved.
          </p>
